...
const LatestJobCards = ({job}) => {
  ...
  return (
    <div onClick ={() => navigate(`/description/${job._id}`)} className='p-8 w-full m-8 rounded-md shadow-xl bg-gray-100 border border-blue-300 cursor-pointer  hover:shadow-2xl'>
      <div>
