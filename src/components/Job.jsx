  ...
  return (
    <div className="p-7 m-5 rounded-md shadow-xl bg-gray-100 border border-blue-300 cursor-pointer  hover:shadow-2xl">
      ...
      <div className="flex items-center gap-4 mt-4">
        <Button onClick={()=>navigate(`/description/${job?._id}`)} variant="outline " className="cursor-pointer bg-blue-400 hover:bg-blue-500">Details</Button>
        <Button className="bg-orange-400 cursor-pointer hover:bg-orange-500">Save For Later</Button>
      </div>
    </div>
  );
};
